...
%
%                 [SPICE_DSKXSI_DCSIZE,1] = size(dc)
%                                  double = class(dc)
%
%                 [SPICE_DSKXSI_ICSIZE,1] = size(ic)
%                                   int32 = class(ic)
%
...
%            otherwise
%
%               error( 'Command syntax:  dskxsi_t( <meta-kernel> )' )
%
%         end
%
%
...
%   refer to the CSPICE routine dskxsi_c.
%
%   MICE.REQ
%   DAS.REQ
%   DSK.REQ
...
%-Version
%
%   -Mice Version 1.0.0, 07-APR-2014, EDW (JPL), NJB (JPL)
%
%-Index_Entries
%
...
function [xpt, handle, dladsc, dskdsc, dc, ic, found] =             ...
   ...
   switch nargin
      ...
      otherwise
         ...
         error ( [ 'Usage: [xpt(3), handle, dladsc(), dskdsc(), '     ...
                   'dc(), ic(), found] = '                            ...
