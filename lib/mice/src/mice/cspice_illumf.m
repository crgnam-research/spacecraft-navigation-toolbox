%-Abstract
%
%   CSPICE_ILLUMF computes the illumination angles---phase, incidence,
%   and emission---at a specified point on a target body. Return logical
...
%   the Mice routine cspice_illumf.
%
%   MICE.REQ
%   ABCORR.REQ
%   DSK.REQ
