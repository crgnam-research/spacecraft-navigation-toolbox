...
This function calls:
   ...
   [posSemiDefCov](posSemiDefCov.md "function pcov_pos = posSemiDefCov(pcov)")
    pcov_pos = posSemiDefCov(pcov)
   [u_sigmas](u_sigmas.md "function [SIGMAS,Wm,Wc,L] = u_sigmas(X_hat,P,alpha,beta,kappa)")
...
```
    ...
    0068         
    0069         % Calculate crosscorrelation covariance (3.266):
